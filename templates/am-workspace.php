...
<div class="dealer-am-wrap" id="dealer-am">
	...
	/* Difesa dal tema: niente barre di sfondo, bordi o serif sui titoli.
	   Classe ripetuta + !important per vincere anche se il CSS del tema
	   viene iniettato dopo il nostro; colore e allineamento con :where(),
	   specificita' zero, cosi' i titoli bianchi restano bianchi. */
	.dealer-am-wrap.dealer-am-wrap :is(h1,h2,h3,h4,h5,h6){background:none!important;border:0!important;box-shadow:none!important;
		padding:0!important;text-transform:none!important;font-family:inherit!important;}
	.dealer-am-wrap.dealer-am-wrap :is(h1,h2,h3,h4,h5,h6)::before,.dealer-am-wrap.dealer-am-wrap :is(h1,h2,h3,h4,h5,h6)::after{content:none!important;background:none!important;}
	:where(.dealer-am-wrap) :where(h1,h2,h3,h4,h5,h6){color:inherit;text-align:left;line-height:1.3;}
	...
	.dealer-am-doc-view{margin-left:8px;font-size:.8rem;font-weight:600;color:var(--am-blue);text-decoration:none;white-space:nowrap;}
	.dealer-am-doc-view:hover,.dealer-am-doc-view:focus{color:var(--am-blue-dk);text-decoration:underline;}
